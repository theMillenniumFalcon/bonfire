...
interface InviteRoomFormProps { }

export const InviteRoomForm: React.FC<InviteRoomFormProps> = ({ }) => {
                ...
                <Box color="#ffffff" width="100%">
                    <Form>
                        <Box pt={4} backgroundColor="#151A21">
                            <InputField name="username" placeholder="username" label="Username of user you want to invite" />
                        </Box>
                        <Flex pt={5} align="center" justify="space-between" color="#0B0E11" backgroundColor="#151A21">
                            <StandardButton color='#ffffff' height="38px" width="120px" content="Send Invite" isLoading={isSubmitting} />
                        </Flex>
                    </Form>
                </Box>
            )}
